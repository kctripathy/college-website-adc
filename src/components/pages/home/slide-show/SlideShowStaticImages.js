          ...
          {slideImages.map((i) => {
            return (
              <Carousel.Item key={i.id}>
                <img
                  className="img img-responsive img-fluid d-block m-0 p-0 rounded"
                  src={i.source}
                  alt={i.captionHead}
                />
                <Carousel.Caption>
                  <h3 className="caption-head text-light m-0 p-0">
                    {i.captionHead}
                  </h3>
                  <p className="caption-label text-light m-0 p-0">
                    {i.captionLabel}
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
