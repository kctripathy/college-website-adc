  ...
  const showLinksAfterLogin = () => (
    <Fragment>
      <li className="nav-item ml-2 dropdown">
        <Link
          className="nav-link nav-link-topmenu dropdown-toggle text-right active"
          to="/"
          id="navbarDropdown"
          role="button"
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-adc">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto col-10">
          ...
          <li className="nav-item ml-2 dropdown">
            <Link
              className={`nav-link nav-link-topmenu dropdown-toggle text-left ${isActiveDropdownItem(
                history,
                "/about"
              )}`}
              to="/"
            ...
            >
              ...
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/about/profile">
                  College Profile
                </Link>
              </li>
              ...
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/about/principal-message">
                  Principal's Message
                </Link>
              </li>
            </ul>
          ...
          <li className="nav-item ml-2 dropdown">
            ...
            >
              ...
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/academic/subject-strength">
                  Subject Strength
                </Link>
              </li>
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/academic/publications">
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/academic/carrer-counselling"
                >
                  Carrer Counselling Cell
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/academic/internal-quality-assurance-cell"
                >
          ...
          <li className="nav-item ml-2 dropdown">
            ...
            >
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/academic-activities"
                >
                  Academic Activities
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/social-activities"
                >
                  Social Activities
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/sports-activities"
                >
                  Sports Activities
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/cultural-activities"
                >
                  Cultural Activities
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/youth-red-cross-activities"
                >
                  Youth Red Cross (YRC)
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/red-ribbon-club-activities"
                >
                  Red Ribbon Club (RCC)
                </Link>
              </li>
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/the-bharat-scout-&-guide-activities"
                >
                  The Bharat Scout & Guide
                </Link>
              </li>
              <li
                className="nav-item  ml-2"
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/national-service-scheme-activities"
                >
              ...
              >
                <Link
                  className="dropdown-item"
                  to="/activities/alumni-activities"
                >
                  Alumni Activities
                </Link>
              </li>
          ...
          <li className="nav-item ml-2 dropdown">
            ...
            >
              ...
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/students/union">
                  Students Union
                </Link>
              </li>
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/students/achievement">
              ...
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/students/alumni">
          ...
          <li className="nav-item ml-2 dropdown">
            ...
            >
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/admin/governing-body">
                  <i className="fa fa-user-tie"></i> Governing Body
                </Link>
              </li>
              <li
                className="nav-item m-1"
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/admin/holiday-list">
                  <i className="fa fa-list-alt"></i> Holiday List
                </Link>
              </li>
              ...
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/rti">
                  <i className="fa fa-question-circle"></i> RTI
                </Link>
              </li>
            </ul>
          </li>
          ...
          <li className="nav-item ml-2 dropdown">
            ...
            >
              <li
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/gallery/photo">
                  <i className="fa fa-images" aria-hidden="true"></i> Photo
                  Gallery
                </Link>
              </li>
              <li
              ...
              >
                <Link className="dropdown-item" to="/gallery/video">
                  <i className="fas fa-film"></i> Video Gallery
                </Link>
              </li>
              <li
                className="nav-item m-1"
                ...
                data-target=".navbar-collapse.show"
              >
                <Link className="dropdown-item" to="/gallery/media">
                  <i className="fa fa-newspaper"></i> Media Gallery
                </Link>
              </li>
            </ul>
          </li>
        ...
        <ul className="navbar-nav ml-auto navbar-right">
          ...
          {!isAuthenticated() && (
            <Fragment>
              ...
              >
                <a
                  className={isActive(history, "/register")}
                ...
                >
                  {RoleID === 1 ? (
                    ...
                    <Fragment>
                      ...
                      <Link className="dropdown-item" to="/student/feedback">
                        Feedback
                      </Link>
                    </Fragment>
                  )}
