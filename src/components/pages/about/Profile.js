      ...
      <div className="col-lg-4 col-sm-12 mb-2">
        <div className="card text-center">
          <div className="card-header">
            ...
            <ProfileImage
              usertype="employee"
              id={profile.Principal_cum_Secratary.EmployeeID}
              height="250px"
              width="250px"
            />
          </div>
          ...
          <div className="card-body">
            <h6 className="card-subtitle">
              {profile.Principal_cum_Secratary.name}
            </h6>
            <p className="card-text">
              {profile.Principal_cum_Secratary.designation} -{" "}
              {profile.Principal_cum_Secratary.department}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-sm-12 mb-2">
        <div className="card text-center">
          <div className="card-header">
            ...
            <ProfileImage
              usertype="employee"
              id={profile.Academic_Bursar.EmployeeID}
              height="250px"
              width="300px"
              photo_url=""
            />
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              {profile.Academic_Bursar.designation} -{" "}
              {profile.Academic_Bursar.department}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-sm-12  mb-2">
        <div className="card text-center">
          <div className="card-header">
            ...
            <ProfileImage
              usertype="employee"
              id={profile.Account_Bursar.EmployeeID}
              height="250px"
              width="250px"
            />
          </div>
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              {profile.Account_Bursar.designation} -{" "}
              {profile.Account_Bursar.department}
            </p>
          </div>
        </div>
      </div>
          ...
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-8 p-2">
                Prof. Sanatana Sahu, HOD of Political Science
              </div>
              <div className="col-4 font-weight-bold p-2">
                Admission in Charge
              </div>
              <div className="col-8 p-2">
                {SAMS.Admission_in_Charge.name},{" "}
                {SAMS.Admission_in_Charge.designation} of{" "}
                {SAMS.Principal.department}{" "}
              </div>
              <div className="col-4 font-weight-bold p-2">
                Data Entry Operator
              </div>
              <div className="col-8 p-2">
                {SAMS.Data_Entry_Operator.name},{" "}
                {SAMS.Data_Entry_Operator.designation} (
                {SAMS.Data_Entry_Operator.department})
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul className="list-group  m-0 p-0">
          ...
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-8 p-2">
                Prof. Pramod Kumar Chaudhuri, HOD of History
              </div>

              <div className="col-4 font-weight-bold p-2">
                Co In Charge of NAAC
              </div>
              <div className="col-8 p-2">
                Prof. Biranchi Narayan Pradhan, Lect. in Political Science
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul className="list-group  m-0 p-0">
          ...
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-8 p-2">
                1. Prof. Binod Kumar Dash, HOD of Economics
              </div>

              <div className="col-4 font-weight-bold p-2">&nbsp;</div>
              <div className="col-8 p-2">
                2. Prof. Niranjan Satapathy, HOD of Odia
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul className="list-group  m-0 p-0">
          ...
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-4 font-weight-bold p-2">Members</div>
              <div className="col-8 p-2">
                1. Prof. Pramod Kumar Chaudhuri, HOD of History
              </div>

              <div className="col-4 font-weight-bold p-2">&nbsp;</div>
              <div className="col-8 p-2">
                2. Prof. Binod Kumar Dash, HOD of Economics
              </div>
            </div>
          </li>
        </ul>
    ...
    <div className="row mt-4 p-0">
      <div className="col-lg-12 col-sm-12">
        <ul className="list-group  m-0 p-0">
          ...
          <li className="list-group-item">
            <span>
              The college has three NSS units (Two for Boys and One for Girls)
            </span>
            <div className="row m-0 p-0">
              <div className="col-lg-4 col-sm-12 font-weight-bold p-2">
                Programme Officer Unit-I (Boys)
              </div>
              <div className="col-lg-8 col-sm-12 p-2">
                Prof. Binod Kumar Dash, HOD of Economics
              </div>

              <div className="col-4 font-weight-bold p-2">
                Programme Officer Unit-II (Boys)
              </div>
              <div className="col-8 p-2">
                Prof. Niranjan Satapathy, HOD of Odia
              </div>

              <div className="col-4 font-weight-bold p-2">
                Programme Officer Unit-III (Girls)
              </div>
              <div className="col-8 p-2">
                Prof. Pramod Kumar Chaudhuri, HOD of History
              </div>
    ...
    <div className="row mt-4 p-0">
      <div className="col-lg-12 col-sm-12">
        <ul className="list-group  m-0 p-0">
          <li className="list-group-item list-group-header bg-section border-text-muted text-dark">
            <h4 className="card-title m-0 p-0">
              Youth Red Cross (YRC) & Red Ribbon Club (RCC) - (Boys & Girls){" "}
            </h4>
          </li>
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-8 p-2">
                Mr. Saroj Kumar Nayak, Data Entry Operator
              </div>
            </div>
          </li>
        </ul>
    ...
    <div className="row mt-4 p-0">
      <div className="col-lg-12 col-sm-12">
        <ul className="list-group  m-0 p-0">
          <li className="list-group-item list-group-header bg-section border-text-muted text-dark">
            <h4 className="card-title m-0 p-0">
              The Bharat Scout & Guide (Boys & Girls)
            </h4>
          </li>
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-8 p-2">
                Prof. Sucharita Kar, HOD of English
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul className="list-group  m-0 p-0">
          ...
          <li className="list-group-item">
            <div className="row m-0 p-0">
              ...
              <div className="col-8 p-2">
                Prof. Bibhuti Bhushan Pradhan, Lect. In. History
              </div>
              <div className="col-4 font-weight-bold p-2">Asst. Adviser</div>
              <div className="col-8 p-2">
                Prof. Biranchi Narayan Pradhan, Lect. In. Political Science
