...
export default function componentName({ title, willshowPhoto }) {
        ...
        return (
          <Fragment key={m.id}>
            ...
            <div className="col-lg-9 col-sm-12 m-0 p-0 pt-3 pb-1 text-left">
              {m.name} <br />{" "}
              <small>{`${m.designation} - ${m.department}`}</small>
            </div>
          ...
          <li className="list-group-item list-group-header bg-section text-dark">
            <h4 className="card-title m-0 p-0">
              {title && title.length > 0
                ? title
                : "Internal Quality Accessment Cell(IQAC)"}
            </h4>
          </li>
          <li className="list-group-item">
            <div className="row m-0 p-0">
              <div className="col-lg-4 col-sm-12 font-weight-bold p-2 pt-4">
              ...
              <div
                className="col-lg-12"
                style={{ height: "1px", border: "solid 1px #eee" }}
              >
                &nbsp;
              </div>
              <div className="col-lg-4 col-sm-12 font-weight-bold p-2 pt-4">
              ...
              <div className="col-lg-8 col-sm-12 p-2">
                <div className="row m-0 p-0 d-flex">{showMembers()}</div>
