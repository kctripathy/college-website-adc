            ...
            <form onSubmit={submitFormHandler}>
                <div className="row d-flex text-left pl-4">
                    ...
                    <div className="d-flex">
                        <label className="p-2"><input name="act" type="radio" value="AAC" />Academic Activity</label>
                        <label className="p-2"><input name="act" type="radio" value="CUA" />Curricular Activity</label>
                        <label className="p-2"><input name="act" type="radio" value="CCA" />Co-curricular Activity</label>
                    </div>
                </div>
            </form>
        </DashboardLayout>
