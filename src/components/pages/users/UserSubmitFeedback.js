...
export default function UserSubmitFeedback() {
    ...
    const submitFormHandler = (e) => {
        ...
        if (validateFormFields()) {
            submitFeedback({ UserID, UserFeedbackType: type, UserFeedbackSubject: subject, UserFeedbackMessage: message })
                .then(data => {
    ...
    const showSubmitFeedbackForm = () => {
        ...
        return <form onSubmit={submitFormHandler} className="mt-4 w-70 ml-5">
            <div className="form-group">
                <label htmlFor="subject" className="required">Feedback Type:</label>
                <select id="type" className="form-control" value={type} onChange={handleChange} required>
            ...
            <div className="form-group" >
                <label htmlFor="subject" className="required">Feedback Subject:</label>
                <input
                    type="text"
            ...
            <div className="form-group">
                <label htmlFor="message" className="required">Feedback Message: </label>
                <textarea type="text"
                    className="form-control"
                    id="message"
                    rows="4"
