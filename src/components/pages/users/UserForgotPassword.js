...
export default function UserForgotPassword() {
    ...
    const submitFormHandler = (e) => {
        ...
        if (validateFormFields()) {
            ...
            forgotPassword({ UserName: username, PhoneNo: phoneno, DateOfBirth: dateofbirth })
                .then(data => {
                ...
                .catch(err => {
                    ...
                    setError("Error while processing! please contact Administrator ", err);
                    setIsProcessing(false);
                })
        }
    };
    ...
    const showForgotPasswordForm = () => {
        ...
        return <form onSubmit={submitFormHandler} className="shadow-sm p-3 mt-3 mb-3 bg-white rounded">
            ...
            <div className="form-group">
                <label htmlFor="phoneno" className="required">Phone Number: </label>
                <input type="number"
                    className="form-control"
                    id="phoneno"
                    value={phoneno}
            ...
            <div className="form-group text-center">
                <button type="submit" className="btn btn-primary pl-2 pr-2">RETRIVE MY PASSWORD</button>
                <button type="button" className="btn btn-primary ml-2 pl-2 pr-2" onClick={resetFormFields}>CLEAR</button>
            </div>
        </form>
    };
