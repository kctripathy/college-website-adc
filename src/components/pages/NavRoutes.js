  ...
  return (
    <div>
      <Switch>
        ...
        <Route
          path="/establishments/:estbTypeCode"
          component={AllEstablishments}
        />
        <Route path="/establishmentdetails" component={EstablishmentDetails} />
        <Route path="/publicationdetails" component={EstablishmentDetails} />
        ...
        />
        <AdminRoute
          path="/administration/establishment/:page"
          component={AdminAddEstablishment}
          exact
        />
        <AdminRoute
          path="/administration/establishments/manage"
          component={AdminManageEstablishments}
          exact
        />
        <AdminRoute
          path="/administration/establishments/manage/:page"
          component={AdminManageEstablishments}
          exact
        />
        ...
        <PrivateRoute
          path="/user/upload-profile-photo"
          component={UserProfilePhotoUpload}
          exact
        />

        <PrivateRoute
          path="/user/add-activity/:UserType/:UserReferenceID"
          component={UserAddActivity}
          exact
        />
        <PrivateRoute
          path="/user/add-publication/:UserType/:UserReferenceID"
          component={UserAddPublication}
          exact
        />
        <PrivateRoute
          path="/user/view-activities/:UserType/:UserReferenceID"
          component={UserViewActivities}
          exact
        />
        <PrivateRoute
          path="/user/view-publications/:UserType/:UserReferenceID"
          component={UserViewPublications}
          exact
        />

        <PrivateRoute
          path="/user/feedback/:UserType/:UserReferenceID"
