  ...
  async submitFileToUpload(e) {
    ...
    return post(url, formData, config)
      .then((response) => {
        ...
        else alert("File updated successfully");
      })
      .catch((err) => {
        this.setState({
          ...this.state,
        ...
        if (!(this.props.mode === "edit"))
          this.props.onUploadSuccessOrFailure(
            "",
            "",
            "Failed to upload the file: " + err
          );
        else alert("Some error occured while updating the file ...");
        console.log(err);
      });
  }
    ...
    return (
      <div className="container-fluid">
        <form onSubmit={(e) => this.submitFileToUpload(e)}>
          ...
          >
            <div
              className="col-12 bg-page-title mt-4 mb-4"
            ...
            <div className="col-12 mb-2">
              ...
              <button
                ...
                style={{
                  display:
                    this.props.mode && this.props.mode === "edit" ? "none" : "",
                }}
              >
                CANCEL
              </button>
            ...
            <div
              className="alert alert-warning mt-2 text-left"
              style={{
                display:
                  this.props.mode && this.props.mode === "edit" ? "none" : "",
              }}
