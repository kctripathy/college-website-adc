...
export default function EstablishmentsEdit({ title, code, description }) {
    ...
    const { EstbID, EstbTypeCode, EstbTypeCodeDescription, EstbDate, EstbTitle, EstbDescription } = values;
    ...
    const ShowAddFormControls = () => (
        <Fragment>
            ...
            <form onSubmit={submitFormHandler} className="col-lg-12 col-sm-12 m-0 p-0 mt-4 w-100 ">
                <EstablishmentTypeCodes code={EstbTypeCode} description={description} handleChangeFormField={(e) => handleChangeFormField(e)} />

                <div className="form-group">
                    <label htmlFor="EstbDate" className="pt-2 mr-2">{EstbTypeCodeDescription} Date (mm/dd/yyyy):</label>
                    <input
                        type="date"
                ...
                <div className="form-group mt-2">
                    <label htmlFor="EstbTitle">Title for {EstbTypeCodeDescription}:</label>
                    <input
                        type="text"
                        className="form-control"
                        id="EstbTitle"
                ...
                <div className="form-group mt-2">
                    <label htmlFor="EstbDescription">Description for {EstbTypeCodeDescription}: </label>
                    <textarea type="text"
                        className="form-control"
                        id="EstbDescription"
                ...
                <div className="form-group text-center">
                    <button type="submit" className="btn btn-primary">Submit {EstbTypeCodeDescription}</button>
                    <button type="button" className="btn btn-primary ml-4">View My {EstbTypeCodeDescription}</button>
    ...
    return (
        <div className="row d-flex text-left pl-4">
            ...
            <div className="col-12 p-0 m-0 bg-page-title" style={{ marginLeft: "-20px !important", textTransform: "uppercase" }}>
                <b>{title}</b>
            </div>
